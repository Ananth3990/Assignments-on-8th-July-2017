...
void resize(int width, int height)
{
	...
	glFrustum(-100.0f, 100.0f, -100.0f, 100.0f, -100.0f, -100.0f);
}
...
void display(void)
{
	...
	void display_fourth(void);
	void display_fifth(void);
	void display_sixth(void);

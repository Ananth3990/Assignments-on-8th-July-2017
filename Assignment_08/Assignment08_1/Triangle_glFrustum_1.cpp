...
void resize(UINT width, UINT height)
{
	...
	if (width <= height)
	{
		...
		glFrustum(-50.0f,50.0f,-50.0f,50.0f,2.0f*((GLfloat)height / (GLfloat)width),100.0f*((GLfloat)height / (GLfloat)width));
	}
	else
	{
		//gluPerspective(45.0f, (GLfloat)width / (GLfloat)height, 0.1f, 100.0f);
		glFrustum(-50.0f*((GLfloat)width / (GLfloat)height), 50.0f*((GLfloat)width / (GLfloat)height), -50.0f, 50.0f, 2.0f, 100.0f);
	}
}
